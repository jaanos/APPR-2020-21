...
ggplot(placa_javnisektor_moski, aes(x=izobrazba, y=placa)) +
  geom_point(color="dark blue", size=2) +
  geom_point(placa_zasebnisektor_moski, aes(x=izobrazba, y=placa), color="dark green", size=2) +
  geom_point(placa_javnisektor_zenske, aes(x=izobrazba, y=placa), color="red", size=2) +
  geom_point(placa_zasebnisektor_zenske, aes(x=izobrazba, y=placa), color="pink", size=2) +
